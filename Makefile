...
test-group-6:
	@$(PYTEST_COMMON) tests/tools tests/filesystem tests/sandbox tests/resources \
		tests/skills tests/optimizers tests/toolchain tests/debug tests/formal \
		formal-tests tests/test_*.py --cov-report=
