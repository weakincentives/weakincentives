...
"""Streaming filesystem validation suite and supplementary suites.

This module contains:
- ``FilesystemStreamingValidationSuite``: streaming read/write/text operations
- ``ReadOnlyFilesystemValidationSuite``: read-only filesystem behavior
- ``SnapshotableFilesystemValidationSuite``: snapshot/restore behavior
"""
...
class FilesystemStreamingValidationSuite:
    """Abstract test suite for streaming Filesystem operations.
