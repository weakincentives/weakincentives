...
"""Tests for FileCreatedTrigger, FileCreatedTriggerState, and StaticFeedbackProvider.

This module complements test_feedback_trigger.py and tests:
- FileCreatedTrigger configuration and session state
- FeedbackTrigger with on_file_created condition
- _should_trigger with file creation triggers
- run_feedback_providers with file creation triggers
- Built-in StaticFeedbackProvider
"""
...
# =============================================================================
# Shared helpers (duplicated from test_feedback_trigger.py for module independence)
# =============================================================================
...
class TestFileCreatedTrigger:
    ...
    def test_creates_trigger_with_filename(self) -> None:
        from weakincentives.prompt import FileCreatedTrigger
