...
# ---------------------------------------------------------------------------
# Backward-compatible adapter aliases
# ---------------------------------------------------------------------------


class TestAdapterAliases:
    """Verify that adapter modules re-export WorkspaceSection as their old names."""

    def test_claude_agent_alias(self) -> None:
        from weakincentives.adapters.claude_agent_sdk.workspace import (
            ClaudeAgentWorkspaceSection,
        )

        assert ClaudeAgentWorkspaceSection is WorkspaceSection
    ...
    def test_prompt_module_exports(self) -> None:
        from weakincentives.prompt import (
            HostMount as ExportedHostMount,
            HostMountPreview as ExportedHostMountPreview,
            WorkspaceBudgetExceededError as ExportedBudgetError,
            WorkspaceSection as ExportedWorkspaceSection,
            WorkspaceSecurityError as ExportedSecurityError,
        )

        assert ExportedWorkspaceSection is WorkspaceSection
        assert ExportedHostMount is HostMount
        assert ExportedHostMountPreview is HostMountPreview
        assert ExportedBudgetError is WorkspaceBudgetExceededError
        assert ExportedSecurityError is WorkspaceSecurityError
