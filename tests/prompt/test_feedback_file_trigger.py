...
"""Tests for FileCreatedTrigger, StaticFeedbackProvider, and related session state.

This module complements test_feedback_trigger.py and tests:
- FileCreatedTrigger configuration
- FileCreatedTriggerState session slice
- FeedbackTrigger with on_file_created conditions
