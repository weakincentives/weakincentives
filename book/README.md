...
1. [**Quickstart**](02-quickstart.md) - Your first agent in 10 minutes

### Part II: Core Abstractions

3. [**Prompts**](03-prompts.md) - Type-safe prompt composition
1. [**Tools**](04-tools.md) - Sandboxed, deterministic tool execution
...
1. [**Sessions**](05-sessions.md) - Event-driven state management

### Part III: Integration & Orchestration

6. [**Adapters**](06-adapters.md) - Provider integrations (OpenAI, LiteLLM, Claude Agent SDK)
1. [**Main Loop**](07-main-loop.md) - Event loop orchestration
   - 7.5 [**Distributed Orchestration**](07.5-distributed-orchestration.md) - Message queues and distributed agents
1. [**Evaluation**](08-evaluation.md) - Testing and quality assurance

### Part IV: Advanced Features

9. [**Lifecycle Management**](09-lifecycle.md) - Production deployment patterns
1. [**Progressive Disclosure**](10-progressive-disclosure.md) - Cost optimization through selective context
1. [**Prompt Optimization**](11-prompt-optimization.md) - Version management and A/B testing
1. [**Workspace Tools**](12-workspace-tools.md) - Planning, VFS, sandboxing, and more

### Part V: Operations & Quality

13. [**Debugging & Observability**](13-debugging.md) - Instrumentation and troubleshooting
01. [**Testing & Reliability**](14-testing.md) - Test strategies and harnesses
01. [**Code Quality**](15-code-quality.md) - Type safety, DbC, and coverage requirements

### Part VI: Practical Applications

16. [**Recipes**](16-recipes.md) - Complete agent patterns
01. [**Troubleshooting**](17-troubleshooting.md) - Common errors and solutions
...
1. **Prompts as programs**: Versioned, type-safe prompt templates with structured output
1. **Weak incentives over orchestration**: Guide with suggestions, enforce with constraints
1. **Session-driven evaluation**: Test against real execution traces, not synthetic datasets
1. **Sandboxed tools**: Copy-on-write filesystems and containerized execution prevent side effects
