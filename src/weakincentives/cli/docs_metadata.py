...
GUIDE_DESCRIPTIONS: dict[str, str] = {
    ...
    "feedback-providers": "Deliver periodic guidance during long tasks",
    "task-completion": "Prevent premature termination with checkers",
    "lease-extension": "Extend message visibility during processing",
