...
"""In-memory streaming implementations for filesystem I/O.

Provides ByteReader and ByteWriter implementations backed by io.BytesIO
buffers, used by InMemoryFilesystem for streaming operations.
"""
