...
class Prompt[OutputT]:
    ...
    def __init__(
        ...
        *,
        ...
        self._registry = PromptRegistry(
            ...
            response_section=cast(Section[SupportsDataclass], response_section)
        ...
        self.placeholders = {
            path: set(values) for path, values in self._registry.placeholders.items()
        }
    ...
    def render(
        ...
        *params: SupportsDataclass,
        ...
        param_lookup = renderer.collect_param_lookup(params)
    ...
    def sections(self) -> tuple[SectionNode[SupportsDataclass], ...]:
        return self._registry.section_nodes

    @property
    def param_types(self) -> set[type[SupportsDataclass]]:
        return self._registry.param_types

    @property
    def chapters(self) -> tuple[Chapter[SupportsDataclass], ...]:
        return self._registry.chapters
    ...
    def expand_chapters(
        ...
        *,
        ...
        if not self._registry.chapters:
            return self
    ...
    def _expand_chapters_all_included(
        ...
        *,
        ...
        chapter_registry = self._registry.chapter_key_registry
        unknown_keys = set(provided_lookup) - set(chapter_registry.keys())
        if unknown_keys:
        ...
        open_sections: list[Section[SupportsDataclass]] = list(
            self._registry.base_sections
        )

        for chapter in self._registry.chapters:
            ...
            if key_present:
                ...
                params = cast(
                    SupportsDataclass,
                    replace(cast(Any, chapter.default_params)),
                )
