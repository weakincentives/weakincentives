...
"""Helpers for normalizing enabled predicates across prompt components."""
...
def callable_requires_positional_argument(callback: Callable[..., Any]) -> bool:
    """Return True when the callable requires at least one positional argument."""
...
def normalize_enabled_predicate(
    ...
    """Normalize enabled predicates to a consistent callable signature."""
...
__all__ = ["callable_requires_positional_argument", "normalize_enabled_predicate"]
