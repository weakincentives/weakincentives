...
"""Throttle policy helpers shared across provider adapters."""
...
def details_from_error(
    ...
    """Build throttle details derived from an existing ThrottleError."""
...
def jittered_backoff(
    *,
    ...
    """Return a jittered backoff delay respecting throttle policy constraints."""
