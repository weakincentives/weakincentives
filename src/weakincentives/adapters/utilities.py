...
"""General-purpose adapter utilities shared across modules."""
...
from ..prompt.tool import ResourceRegistry, Tool, ToolResult
...
if TYPE_CHECKING:
    from ._provider_protocols import ProviderMessage, ProviderToolCall
...
def raise_tool_deadline_error(
    *, prompt_name: str, tool_name: str, deadline: Deadline
    ...
    """Raise a PromptEvaluationError representing a tool deadline violation."""
