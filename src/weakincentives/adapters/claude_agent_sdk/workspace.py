...
"""Workspace re-exports for Claude Agent SDK adapter.
...
weakincentives.adapters.claude_agent_sdk.workspace import …`` statements
continue to work.
"""
...
ClaudeAgentWorkspaceSection = WorkspaceSection
