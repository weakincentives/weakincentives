...
"""Helper functions and constants extracted from session.py.

Contains utilities for session initialization, invariant checks, and
hierarchy traversal that do not depend on Session's internal state
(beyond accessing its public API).
"""
...
# ---------------------------------------------------------------------------
# Type cast constants for telemetry event types
# ---------------------------------------------------------------------------
