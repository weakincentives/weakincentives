...
For observability, prompt management, and evaluation capabilities, see
[LANGSMITH_INTEGRATION.md](./LANGSMITH_INTEGRATION.md). LangSmith integrates
naturally with LangGraph and provides:

- **Centralized prompt management** via Prompt Hub
- **Automatic tracing** when environment variables are configured
- **Version pinning** for production deployments
- **OpenTelemetry support** for cross-service observability
...
For LangSmith integration module structure, see
[LANGSMITH_INTEGRATION.md](./LANGSMITH_INTEGRATION.md#module-structure).
...
For LangSmith integration dependencies, see
[LANGSMITH_INTEGRATION.md](./LANGSMITH_INTEGRATION.md#dependencies).
...
For LangSmith references, see
[LANGSMITH_INTEGRATION.md](./LANGSMITH_INTEGRATION.md#references).
