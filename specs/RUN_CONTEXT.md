...
2. **Fresh run_id**: Each execution gets a new `run_id`, never reused
3. **Preserved trace context**: `trace_id` and `span_id` pass through unchanged
4. **Optional everywhere**: All integration points accept `run_context: RunContext | None`
